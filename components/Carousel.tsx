...
const items = [
    ...
    { id: 8, title: 'Prison Break', image: 'https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/B661D1CF4B2D5C3EED3456C80726E412E5AF83F8C1C78A707F6D3AD27C56D67D/scale?width=1200&aspectRatio=1.78&format=webp' },
  ]
...
const Carousel = () => {
  ...
  return (
    <div className="relative bg-[#141414] h-screen">
      <h2 className="text-2xl font-bold mb-4 text-white p-6">Critically Acclaimed US TV Shows</h2>
          ...
          {items.map((item) => (
            <div key={item.id} className="flex-none">
              ...
              <img
                src={item.image}
                alt={item.title}
                className="h-[180px] w-[260px] object-fill rounded-md transition-transform duration-300 ease-in-out hover:scale-125"
              />
